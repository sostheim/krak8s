...
// CreateApplicationInternalServerError runs the method Create of the given controller with the given parameters and payload.
// It returns the response writer so it's possible to inspect the response headers.
// If ctx is nil then context.Background() is used.
// If service is nil then a default service is created.
func CreateApplicationInternalServerError(t goatest.TInterface, ctx context.Context, service *goa.Service, ctrl app.ApplicationController, projectid string, payload *app.ApplicationPostBody) http.ResponseWriter {
	// Setup service
	var (
		logBuf bytes.Buffer
		resp   interface{}
...
// CreateApplicationNotFound runs the method Create of the given controller with the given parameters and payload.
// It returns the response writer so it's possible to inspect the response headers.
// If ctx is nil then context.Background() is used.
// If service is nil then a default service is created.
func CreateApplicationNotFound(t goatest.TInterface, ctx context.Context, service *goa.Service, ctrl app.ApplicationController, projectid string, payload *app.ApplicationPostBody) http.ResponseWriter {
	// Setup service
	var (
		logBuf bytes.Buffer
		resp   interface{}
...
// GetApplicationNotFound runs the method Get of the given controller with the given parameters.
// It returns the response writer so it's possible to inspect the response headers.
// If ctx is nil then context.Background() is used.
// If service is nil then a default service is created.
func GetApplicationNotFound(t goatest.TInterface, ctx context.Context, service *goa.Service, ctrl app.ApplicationController, projectid string, appid string) http.ResponseWriter {
	// Setup service
	var (
		logBuf bytes.Buffer
		resp   interface{}
