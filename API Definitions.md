...
Alternately: if you prefer based on previous experience, you can use the [Swagger.io Editor](https://editor.swagger.io/?spec=https://raw.githubusercontent.com/samsung-cnct/krak8s/master/swagger/swagger.json#) to view the raw JSON and API side by side.
